...
export const Skills = [
    ...
    {id: 2, linguagem: 'CSS', imagem: cssImg},
    {id: 3, linguagem: 'Sass', imagem: sassImg},
    {id: 4, linguagem: 'TailWindcss', imagem: tailwindcssImg},
    {id: 5, linguagem: 'Javascript', imagem: jsImg},
